...
- GhostScript 10.05.1（PDF压缩与转图片，已内置，无需额外安装）
...
- Windows 10/11
- .NET 10.0 桌面运行时
  - 下载地址：[.NET 10.0 Desktop Runtime](https://dotnet.microsoft.com/zh-cn/download/dotnet/10.0)
- Ghostscript
  - Windows电脑安装：10.05.1（已内置在安装包中，无需额外安装），手动安装：[Ghostscript官网下载](https://ghostscript.com/releases/gsdnld.html)、[Ghostscript Github下载](https://github.com/ArtifexSoftware/ghostpdl-downloads/releases)
